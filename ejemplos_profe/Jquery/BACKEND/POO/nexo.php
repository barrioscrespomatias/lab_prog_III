    ...
    case 'traerListadoCD':
        ...
        foreach ($consulta as $cd) {
            ...
            $tabla .= "<tr>
                            ...
                            <td>" . $cd->interprete . "</td>
                            <td>" . $cd->anio . "</td>
                            <td><input type='button' data-action='btn_eliminar' data-obj='" . $obj . "' value='Eliminar'></td>
                            <td><input type='button' data-action='btn_modificar' data-obj='" . $obj . "' value='Modificar'></td>                                                      
                       </tr>";
