...
///<reference path="../administracion.php"/>
...
(function (Main) {
    ...
    function MostrarGrilla() {
        ...
        ajax.Post("http://localhost/lab_prog_III/laboratorio_3/clase04/abm_archivos_starter/administracion.php", MostrarGrillaSuccess, parametros);
    }
    ...
    function EliminarProducto(codBarra) {
        ...
        ajax.Post("http://localhost/lab_prog_III/laboratorio_3/clase04/abm_archivos_starter/administracion.php", DeleteSuccess, parametros, Fail);
    }
