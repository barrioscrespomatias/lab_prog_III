...
(function (Main) {
    var ajax = new Ajax();
    var selectProvincia = Dom.ObtenerPorId("provincias");
    Main.CargarProvincias = function () {
        ajax.Post('servidor.php', Manejadora, "accion=cargar");
    };
    var Manejadora = function (cadena) {
        selectProvincia.innerHTML = "";
        selectProvincia.value = cadena;
        var opcion = "<option value='0'> " + selectProvincia.innerHTML + "</option>";
        document.getElementById("provincias").innerHTML += opcion;
    };
})(Main || (Main = {}));
