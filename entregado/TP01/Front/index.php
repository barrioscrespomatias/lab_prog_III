                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            ...
                            echo '<input type="number" name="txtDni" id="txtDni" max="55000000" min="1000000" readonly value="<?php echo trim($empleadoAuxiliar->GetDni())?>">';
                            echo '<span style="display: none;" id="txtDniError">*</span>';
                            }
                            else
                            echo '<input type="number" name="txtDni" id="txtDni" max="55000000" min="1000000" value="">';
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <?php if($valorDniEmpleado != "Error"){
                            echo '<input type="text" name="txtApellido" id="txtApellido" value="<?php echo trim($empleadoAuxiliar->GetApellido()) ?>">';
